                            ...
                            <tbody>
                                @foreach ($liste as $achatListe)
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                if($achatListe['ressut'] == false)
                                                {
                                            ?>
                                                <a href="{{ route('achat.details', ['numAchat' => $achatListe['numAchat']]) }}"
                                                    type="button" class="btn  btn-outline-info btn-fw">
                                            ...
                                            ?>
                                                <a type="button" href="{{ route('liste.achat', ['numAchat' => $achatListe['numAchat']]) }}" class="btn  btn-outline-success btn-fw"e
                                                    <i class="mdi mdi-view"></i>
                                                    Details
                                                </a>
                                            <?php
