    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-outline-primary btn-fw" data-toggle="modal" data-target="#uupdateDepot">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="forms-sample" action="{{ route('valider_livraison.update_depot') }}" method="post">
                                    @csrf
                                    <input type="hidden" name="numLivraison" value="{{ $details[0]['num_livraison'] }}">
