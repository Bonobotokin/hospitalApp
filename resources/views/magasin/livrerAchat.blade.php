        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('achat_livraison') }}">
                    ...
                    @for ($i = 0; $i < count($achat); $i++) <input type="hidden" name="{{ $i }}[achat_id]" value="{{ $achat[0]['achat_id'] }}">
                        <input type="hidden" name="{{ $i }}[numAchat]" value="{{ $achat[0]['numAchat'] }}">

                        <div class="row m-20">
                            <input type="hidden" name="{{ $i }}[produits_id]" value="{{ $achat[$i]['produits_id'] }}">

                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="">Designation :</label>
                                    <input type="text" class="form-control" value="{{ $achat[$i]['abrev'] }} - {{ $achat[$i]['types'] }}" />
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="">Condit:</label>
                                    <input name="{{ $i }}[conditionnement]" type="text" class="form-control" value="{{ $achat[$i]['conditionnnement_achat'] }}" />
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input name="{{ $i }}[quantite]" type="number" class="form-control" />
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="">Qt Total:</label>
                                    <input name="{{ $i }}[total]" type="number" class="form-control" />
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="">Prix:</label>
                                    <input name="{{ $i }}[prix_achat]" type="number" class="form-control" />
                                </div>
                            </div>
                        </div>
                        @endfor
