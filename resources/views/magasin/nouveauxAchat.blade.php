                                ...
                                <blockquote class="blockquote blockquote-primary">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 mt-2">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="numAchat">Numero d'achat :</label>
                                                    @if ($numAchat->isNotempty())
                                                        <?php
                                                            $numero = $numAchat[0]['numAchat'] + 1;
                                                        ?>
                                                        <input value="{{ $numero }}" type="number" class="form-control" name="numAchat" placeholder="Numero de l'achat">
                                                    @elseif ($numAchat->isEmpty())

                                                    <input type="number" class="form-control" name="numAchat" placeholder="Numero de l'achat" value="1">
